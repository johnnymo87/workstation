...
OSC 52 and gclpr only handle **text**. For sharing images with a remote opencode session over SSH, use the [screenshot-to-remote-opencode](../screenshot-to-remote-opencode/SKILL.md) helper script, which:
