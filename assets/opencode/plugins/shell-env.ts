...
function loadSecretEnv(read: (path: string) => string | undefined): Record<string, string> {
  ...
  const simple: ReadonlyArray<readonly [string, string]> = [
    ...
    ["atlassian_alt_site", "ATLASSIAN_ALT_SITE"],
    ["atlassian_alt_email", "ATLASSIAN_ALT_EMAIL"],
    ["atlassian_alt_cloud_id", "ATLASSIAN_ALT_CLOUD_ID"],
    ["atlassian_alt_api_token", "ATLASSIAN_ALT_API_TOKEN"],
