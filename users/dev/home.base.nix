...
let
  ...
  opencode-platforms = {
    aarch64-linux = {
      ...
      hash = "sha256-Tw9DJZM1U0qAEVz/e88SQ5OTJA6JztEvPJr6PqZB0l0=";
      isZip = false;
    };
    aarch64-darwin = {
      asset = "opencode-darwin-arm64.zip";
      hash = "sha256-KrmD5Nu7tNF9IUbh7WZeFfHbIYLTSCmi8hk3kTtxtQ8=";
      isZip = true;
    };
    x86_64-linux = {
      asset = "opencode-linux-x64.tar.gz";
      hash = "sha256-Vn3F6DeJAJQVWBmGl3CBgwJ08yOyL4mtTV5HnT1TKqo=";
      isZip = false;
    };
    x86_64-darwin = {
      asset = "opencode-darwin-x64.zip";
      hash = "sha256-MtB+q1YERU+wedBc54AV0/i5JkXMRr8RUyadN6oC8R4=";
      isZip = true;
    };
  };
...
in
{
  ...
  home.activation.generateBazelrc = lib.mkIf (isDarwin || isCloudbox) (lib.hm.dag.entryAfter [ "writeBoundary" ] (let
    ...
    staticFooter = lib.concatStringsSep "\n" ([
      ...
      "#"
      "# THIS IS A MITIGATION, NOT A FIX. --jobs is per-invocation, so two concurrent"
      "# builds on one serve still breach the ceiling, and nothing here bounds the"
      "# aggregate across invocations, server JVMs, or throwaway worktrees. The real fix"
      "# is to stop charging builds to the serve cgroup at all -- see workstation-mqp3."
      "#"
